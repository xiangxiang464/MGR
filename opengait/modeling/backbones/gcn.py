...
#     def __init__(self, num_parts, in_features, out_features, num_layers=2, isMeanPooling=True):
#         super(GCN, self).__init__()
#         self.layers = ModuleList()
#         self.layers.append(GCNLayer(in_features, out_features, isMeanPooling=isMeanPooling))
#         for _ in range(1, num_layers):
#             self.layers.append(GCNLayer(out_features, out_features, isMeanPooling=isMeanPooling))
#
#     def forward(self, x, adj):
